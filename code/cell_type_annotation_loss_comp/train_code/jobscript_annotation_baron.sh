...
apptainer exec /cephyr/users/leoan/Alvis/CELLULAR_reproducibility/CELLULAR_env.sif python benchmark_annotation.py '/mimer/NOBACKUP/groups/naiss2023-6-290/Leo_Andrekson/Masters_Thesis/data/processed/data_for_evaluating_cell_type_annotation/Baron.h5ad' 'trained_models/Assess_generalisability/Baron/' 'benchmark_results/Baron/Benchmark_results' '' 'Baron'