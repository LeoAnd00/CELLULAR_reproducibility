...
import torch
import random
from benchmark_representation import classifier_train as benchmark
...
# Then:
# sbatch jobscript_rep_macparland.sh
# sbatch jobscript_rep_segerstolpe.sh
# sbatch jobscript_rep_baron.sh
...
def main(data_path: str, model_path: str, result_csv_path: str, image_path: str, dataset_name: str):
    ...
    for fold in folds:
        ...
        print()
        benchmark_env.CELLULAR_full_loss_classifier(save_path=f'{model_path}CELLULAR_full_loss/', train=False, umap_plot=False, save_figure=False)
        benchmark_env.CELLULAR_CL_loss_classifier(save_path=f'{model_path}CELLULAR_CL_loss/', train=False, umap_plot=False, save_figure=False)
        benchmark_env.CELLULAR_centroid_loss_classifier(save_path=f'{model_path}CELLULAR_centroid_loss/', train=False, umap_plot=False, save_figure=False)
