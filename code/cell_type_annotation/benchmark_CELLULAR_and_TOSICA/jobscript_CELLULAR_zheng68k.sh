...
apptainer exec /cephyr/users/leoan/Alvis/CELLULAR_reproducibility/CELLULAR_env.sif python CELLULAR_annotation.py '/mimer/NOBACKUP/groups/naiss2023-6-290/Leo_Andrekson/Masters_Thesis/data/processed/data_for_evaluating_cell_type_annotation/Zheng68k.h5ad' 'trained_models/Assess_generalisability/Zheng68k/' '../Zheng68k/results/CELLULAR_output' 'Zheng68k'