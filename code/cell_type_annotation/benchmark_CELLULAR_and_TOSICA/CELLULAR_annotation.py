...
# Then:
# sbatch jobscript_CELLULAR_macparland.sh
# sbatch jobscript_CELLULAR_segerstolpe.sh
# sbatch jobscript_CELLULAR_baron.sh
# sbatch jobscript_CELLULAR_zheng68k.sh


def main(data_path: str, model_path: str, result_csv_path: str, dataset_name: str):
    """
    ...
    for fold in folds:
        ...
        print()
        benchmark_env.CELLULAR_classifier(save_path=f'{model_path}CELLULAR/', train=False)
...
if __name__ == "__main__":
    ...
    main(args.data_path, args.model_path, args.result_csv_path, args.dataset_name)