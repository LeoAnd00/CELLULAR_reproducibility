...
class PBMCs_1(automatic_preprocessing):
    ...
    def cell_labeling_(self):
        ...
        name = "PBMCs_1"
        tissue = "Immune system"
        args = ["PBMCs_1", self.res, tissue] # File name and resolution
...
class PBMCs_2(automatic_preprocessing):
    ...
    def cell_labeling_(self):
        ...
        name = "PBMCs_2"
        tissue = "Immune system"
        args = ["PBMCs_2", self.res, tissue] # File name and resolution
...
class PBMCs_3(automatic_preprocessing):
    ...
    def cell_labeling_(self):
        ...
        name = "PBMCs_3"
        tissue = "Immune system"
        args = ["PBMCs_3", self.res, tissue] # File name and resolution
...
class PBMCs_4(automatic_preprocessing):
    ...
    def cell_labeling_(self):
        ...
        name = "PBMCs_4"
        tissue = "Immune system"
        args = ["PBMCs_4", self.res, tissue] # File name and resolution
...
class PBMCs_5(automatic_preprocessing):
    ...
    def cell_labeling_(self):
        ...
        name = "PBMCs_5"
        tissue = "Immune system"
        args = ["PBMCs_5", self.res, tissue] # File name and resolution
...
class PBMCs_6(automatic_preprocessing):
    ...
    def cell_labeling_(self):
        ...
        name = "PBMCs_6"
        tissue = "Immune system"
        args = ["PBMCs_6", self.res, tissue] # File name and resolution
        output_path = "../../../data/processed/immune_cells/pbmcs_human/PBMCs_6_adata.h5ad"

        self.cell_labeling(RScript_path, name, args, output_path)

class pancreas_1(automatic_preprocessing):
    ...
    def QC_filter_(self):
        ...
        self.QC_filter(file_base=adata, name=name, thresholds=thresholds, adata_input=True)
    
    def cell_labeling_(self):
        RScript_path = 'functions\cell_labeling.R'
        name = "pancreas_1"
        tissue = "Pancreas"
        args = ["pancreas_1", self.res, tissue] # File name and resolution
        output_path = "../../../data/processed/pancreas_cells/pancreas_1_adata.h5ad"

        self.cell_labeling(RScript_path, name, args, output_path)

class kidney_1(automatic_preprocessing):
    ...
    def QC_filter_(self):
        # Path of data
        file_base = '../../../data/raw/kidney_cells/GSM4572192_Control1_filtered_feature_bc_matrix.h5'
        thresholds = [5,5,5,10]
        name = "Kidney_1"
    ...
    def cell_labeling_(self):
        ...
        name = "Kidney_1"
        tissue = "Kidney"
        args = ["Kidney_1", self.res, tissue] # File name and resolution
        output_path = "../../../data/processed/kidney_cells/kidney_1_adata.h5ad"

        self.cell_labeling(RScript_path, name, args, output_path)

class kidney_2(automatic_preprocessing):
    ...
    def QC_filter_(self):
        # Path of data
        file_base = '../../../data/raw/kidney_cells/GSM4572193_Control2_filtered_feature_bc_matrix.h5'
        thresholds = [5,5,5,8]
        name = "Kidney_2"
    ...
    def cell_labeling_(self):
        ...
        name = "Kidney_2"
        tissue = "Kidney"
        args = ["Kidney_2", self.res, tissue] # File name and resolution
        output_path = "../../../data/processed/kidney_cells/kidney_2_adata.h5ad"

        self.cell_labeling(RScript_path, name, args, output_path)

class kidney_3(automatic_preprocessing):
    ...
    def QC_filter_(self):
        # Path of data
        file_base = '../../../data/raw/kidney_cells/GSM4572194_Control3_filtered_feature_bc_matrix.h5'
        thresholds = [5,5,5,8]
        name = "Kidney_3"
    ...
    def cell_labeling_(self):
        ...
        name = "Kidney_3"
        tissue = "Kidney"
        args = ["Kidney_3", self.res, tissue] # File name and resolution
        output_path = "../../../data/processed/kidney_cells/kidney_3_adata.h5ad"
...
class Merge():
    ...
    def Muto_merge(self):
        ...
        filenames = ['kidney_1_adata.h5ad', 'kidney_2_adata.h5ad', 'kidney_3_adata.h5ad']
        ...
        for k, name in enumerate(filenames):
            file = file_paths + name
            adata_temp = sc.read(file, cache=True)
            adata_temp.obs['patientID'] = ['Muto_'+samp_let[k]]*adata_temp.n_obs
            adata_temp.obs['study'] = ['Muto']*adata_temp.n_obs
            adata_temp.obs['chemistry'] = ['v3.1_10X']*adata_temp.n_obs
            adata_temp.obs['tissue'] = ['Kidney']*adata_temp.n_obs
            adata_temp.obs['species'] = ['Human']*adata_temp.n_obs
            adata_temp.obs['data_type'] = ['UMI']*adata_temp.n_obs
            adata.append(adata_temp) 

        adata = adata[0].concatenate(adata[1:], batch_key='sample_ID', 
                                               batch_categories=['Muto_1','Muto_2', 'Muto_3'])
...
def auto_preprocessing_and_labeling(resolution: str = "0.8", delete: bool = False):
    ...
    # Human Pancreas
    pancreas_1_env = pancreas_1(res = resolution)
    pancreas_1_env.QC_filter_()
    pancreas_1_env.cell_labeling_()
    del pancreas_1_env

    # Human Kidney
    kidney_1_env = kidney_1(res = resolution)
    kidney_1_env.QC_filter_()
    kidney_1_env.cell_labeling_()
    del kidney_1_env

    kidney_2_env = kidney_2(res = resolution)
    kidney_2_env.QC_filter_()
    kidney_2_env.cell_labeling_()
    del kidney_2_env

    kidney_3_env = kidney_3(res = resolution)
    kidney_3_env.QC_filter_()
    kidney_3_env.cell_labeling_()
    del kidney_3_env
